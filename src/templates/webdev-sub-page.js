...
const BlogPostTemplate = (props) => {
  ...
  const nextLinkStatus = pageContext?.next ? pageContext?.next?.frontmatter?.templateKey === 'webdev-sub-page' ? true : false : false
  const previousLinkStatus = pageContext?.previous ? pageContext?.previous?.frontmatter?.templateKey === 'webdev-sub-page' ? true : false : false
