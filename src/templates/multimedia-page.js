...
export const MultimediaPageQuery = graphql`
query IndexPage {
  site {
    siteMetadata {
      title
  ...
  markdownRemark(frontmatter: {templateKey: {eq: "multimedia-page"}}) {
    frontmatter {
      title
      description
      thumbnail {
  ...
  allMarkdownRemark(
    filter: {frontmatter: {templateKey: {eq: "multimedia-sub-page"}}}
    limit: 30
