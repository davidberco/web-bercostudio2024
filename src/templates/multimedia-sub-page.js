...
const BlogPostTemplate = (props) => {
  ...
  const nextLinkStatus = pageContext.next ? pageContext.next.frontmatter.templateKey === 'multimedia-sub-page' ? true : false : false
  const previousLinkStatus = pageContext.previous ? pageContext.previous.frontmatter.templateKey === 'multimedia-sub-page' ? true : false : false
